...
public class FuncionarioDAO {
    ...
    public void cadastrarFuncionario(Funcionario obj) {
        ...
        try {
            ...
            if (!verificaSeUsuarioExiste(obj.getEmail())) {

                PreparedStatement stmt = con.prepareStatement(sql);

                stmt.setString(1, !"".equals(obj.getNome()) ? obj.getNome() : "");
                stmt.setString(2, !"".equals(obj.getRg()) ? obj.getRg() : "");
                stmt.setString(3, !"".equals(obj.getCpf()) ? obj.getCpf() : "");
                stmt.setString(4, !"".equals(obj.getEmail()) ? obj.getEmail() : "");
                stmt.setString(5, !"".equals(obj.getSenha()) ? obj.getSenha() : "");
                stmt.setString(6, !"".equals(obj.getCargo()) ? obj.getCargo() : "");
                stmt.setString(7, !"".equals(obj.getNivelAcesso()) ? obj.getNivelAcesso() : "");
                stmt.setString(8, !"".equals(obj.getCelular()) ? obj.getCelular() : "");
                stmt.setString(9, !"".equals(obj.getTelefone()) ? obj.getTelefone() : "");
                stmt.setString(10, !"".equals(obj.getCep()) ? obj.getCep() : "");
                stmt.setString(11, !"".equals(obj.getEndereco()) ? obj.getEndereco() : "");
                stmt.setInt(12, obj.getNumero() != 0 ? obj.getNumero() : 0);
                stmt.setString(13, !"".equals(obj.getBairro()) ? obj.getBairro() : "");
                stmt.setString(14, !"".equals(obj.getCidade()) ? obj.getCidade() : "");
                stmt.setString(15, !"".equals(obj.getComplemento()) ? obj.getComplemento() : "");
                stmt.setString(16, !"".equals(obj.getUf()) ? obj.getUf() : "");
    ...
    private boolean verificaSeUsuarioExiste(String email) {
        try {
